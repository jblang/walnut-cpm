...
/*      : : : : : : : : : : : : : : : : : : : : : : : : : : : : 
        ...
        ucsdtype -- Transfer '.TEXT' files from a UCSD directory 
		    to cp/m console device.
 
		 -- Based upon the program UCSD2CPM.
		    Kludged by Chris Undery
		    11 Margaret St, Newtown
...
#define SET_TRK 10              /* bios index number (was 9 c.u.) */ 
#define SET_SEC 11              /* bios index number (was 10 c.u) */ 
#define READ    13              /* bios index number (was 12 c.u) */ 
...
char tofile[BUFSIZ];	/* cp/m destination file buffer */ 
...
copy(ucsd_file,cpm_file) 
        ...
        while( (c = getbyte()) != EOF_F ) 
          switch(c) { 
            ...
            case CR:    putchar(CR);       /* LF after CR */ 
                        putchar(LF); 
                        break; 
            ...
            default:    putchar(c);        /* pass char unmodified */ 
                        break; 
            } 
   	puts("** end of UCSD file **\n");
